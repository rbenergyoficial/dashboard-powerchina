...
const SISTEMA = {
  ...
  '#8B7FD4': 'roxo acento (curtailment/restrição)', '#453C6E': 'roxo fill (curtailment)',
  '#C5CBD4': 'texto rótulo de linha (tabela)', '#A8B0BC': 'texto rótulo de coluna',
  '#171A1F': 'fundo de linha destacada',
